...
inline const Entry& get(S key) {
    static const Entry table[] = {
        ...
        {"  --event-stream      \xe7\x89\x88\xe6\x9c\xac\xe5\x8c\x96 JSON Lines \xe4\xba\x8b\xe4\xbb\xb6\xe6\xb5\x81\xef\xbc\x88GUI \xe9\x9b\x86\xe6\x88\x90\xef\xbc\x89",
         "  --event-stream      Versioned JSON Lines event stream (GUI integration)"},
        {"  --complete          \xe9\x80\x92\xe5\xbd\x92\xe5\x88\x86\xe8\xa7\xa3\xe4\xb8\xba\xe5\xae\x8c\xe6\x95\xb4\xe8\xb4\xa8\xe5\x9b\xa0\xe6\x95\xb0",
         "  --complete          Recursively produce the complete prime factorization"},
