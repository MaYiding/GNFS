...
![Visual target 2 beside the final GNFS Workbench implementation](apps/macos/GNFSWorkbench/Design/target-vs-implementation.png "Visual target 2 on the left and GNFS Workbench on the right")

The source target and final implementation remain available separately:

- [Direction 2](apps/macos/GNFSWorkbench/Design/design-direction-2.png)
- [Final live dashboard](apps/macos/GNFSWorkbench/Design/final-live-dashboard.png)
...
| 1 | P2 | The header omitted direct history, parameter, cancellation, retry, and overflow actions. | Added working native controls with disabled states, help text, keyboard behavior, and accessibility labels. |
...
|---|---|:---:|
| Active run | [Live dashboard](apps/macos/GNFSWorkbench/Design/final-live-dashboard.png) | Passed |
| Complete factorization | [Result state](apps/macos/GNFSWorkbench/Design/complete-factorization.png) | Passed |
| Failure at minimum size and large text | [Failure state](apps/macos/GNFSWorkbench/Design/failure-large-text.png) | Passed |
| Local run history | [History popover](apps/macos/GNFSWorkbench/Design/history-popover.png) | Passed |
| Advanced configuration | [Parameter inspector](apps/macos/GNFSWorkbench/Design/parameter-inspector.png) | Passed |
...
- Method selection, advanced parameters, history, log search and filtering, copy actions, cancellation, retry, and new-run recovery use working state transitions.
...
- The headless suite exercises 25 unit, integration, process, persistence, cancellation, and offscreen rendering checks.
