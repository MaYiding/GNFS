...
|------|----------|------|----------|------|------|
| L1 | 143, 9991, 10403 | 8–14 | 3–5 | < 0.2s | 极小 |
| L2 | 96091, 100160063 | 17–27 | 5–9 | < 1s | 瞬时 |
| L3 | 1000036000099 | 40 | 13 | ~2s | 快速 |
| L4 | 100000980001501 | 47 | 15 | ~5s | 秒级 |
| L5 | 1253371692427905599 | 61 | 19 | ~38s | 半分钟 |
| 25 位 | 1669994516749619561652133 | 81 | 25 | ~1s (中位数) | 全面优化 |
| 50 位 | (164-bit 半素数) | 164 | 50 | ~2.6h | 压力测试 |
| 60 位 | (200-bit 半素数) | 200 | 60 | 小时级 | 压力测试 |

**25 位分解各阶段耗时** (中位数): 多项式 60ms, 因子基 20ms, 筛法+余因子 600ms, Block Lanczos 100ms, 平方根 200ms
