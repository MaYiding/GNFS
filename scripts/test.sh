...
MODULE_TESTS=(
    ...
    cofactor       "test_cofactor test_squfof test_brent_pollard_rho test_survival_predictor test_batch_ecm test_3lp_cofactor test_trial_wheel test_batch_trial test_ecm_curve_pool test_ecm_stage2_parallel test_ecm_stage1_parallel test_batch_inversion test_integration test_ecm_brent_suyama"
