...
path_to_module() {
    ...
    case "$path" in
        ...
        tests/test_ecm_curve_plan.cpp|tests/test_cofactor_attempt_context.cpp) echo "cofactor" ;;
        ...
        tests/test_sieve_checkpoint.cpp|tests/test_distributed_sieve.cpp|tests/test_distributed_sieve_execution_policy.cpp|tests/test_distributed_sieve_seed_v2.cpp|tests/test_distributed_sieve_resume.cpp) echo "sieve" ;;
        *core/*)       echo "core" ;;
        *util/*)       echo "util" ;;
